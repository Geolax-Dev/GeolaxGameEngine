...
// 
// These defaults can be changed by defining GGE_LOGICAL_LAYOUT
// and/or GGE_COORDINATES
// 
...
#define GGE_COORDINATES_LEFT_HANDED 0
...
#define GGE_COORDINATES_RIGHT_HANDED 1

// Default HLSL++ coordinate system is Left-Handed
// It can be changed by overriding this definition value externally
#if !defined(GGE_COORDINATES)
	#define GGE_COORDINATES GGE_COORDINATES_LEFT_HANDED
#endif

#if GGE_COORDINATES == GGE_COORDINATES_LEFT_HANDED
	#define GGE_COORDINATES_SIGN 1.0f
#else
	#define GGE_COORDINATES_SIGN -1.0f
#endif
...
#if ((GGE_LOGICAL_LAYOUT == GGE_LOGICAL_LAYOUT_ROW_MAJOR) && (GGE_COORDINATES == GGE_COORDINATES_RIGHT_HANDED)) || \
	((GGE_LOGICAL_LAYOUT == GGE_LOGICAL_LAYOUT_COL_MAJOR) && (GGE_COORDINATES == GGE_COORDINATES_LEFT_HANDED))

	#define GGE_LAYOUT_COORDINATES_FLIP_SIGN
